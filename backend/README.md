...
## Project Structure
    ...
    ├── testapiautoteammem_111472  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_111472`
...
2. Clone this repo and `cd testapiautoteammem_111472`
